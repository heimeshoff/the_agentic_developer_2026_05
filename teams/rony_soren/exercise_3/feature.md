...
## UI Decision (2026-06-03)

**Tech:** Blazor Server — reuses C# domain types directly, no separate API layer.

**Screens:** Target Allocation Editor, Current Holdings Editor, Rebalance Results.

**Out of scope:** persistence, auth, real-time prices, transaction history.

See `.claude/backlog/WI-001-blazor-ui.md` for full specification.
